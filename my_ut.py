...
# save_dii={'-HEIGHT': [], '-WEIGHT': [], '-EAT': [2], '-BAD': [], '-EMO': []}
...
# cou=[save_dii[i]==[] for i in save_dii]
# print(cou)
# def test():
#     for i,ele in enumerate(save_dii):
#         if save_dii[ele]==[] and ele not in used:
#             used.append(ele)
#
#             # print(ele)
#             return ele
